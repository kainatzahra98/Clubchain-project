...
const { joinClub, getTasks, handleTask, getAllMembers, getMyClubs, deactivateMembership, getMemberStats, getMemberEvents, updateMemberNotes, getMemberDetails, getAllMemberships } = require('../controllers/member.controller');
